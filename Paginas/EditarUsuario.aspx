<%@ Page Title="" Language="C#" MasterPageFile="~/Paginas/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="EditarUsuario.aspx.cs" Inherits="Paginas_editUser" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="ConteudoAdmin">
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                   <!-- <asp:TextBox ID="txtData" CssClass="form-control" required title="" runat="server" Width="160px" ></asp:TextBox>-->
                     <input type="date" name="DataNascimentoEditarUsuario" />
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="TextBox1" CssClass="form-control" required title="" Width="180px" runat="server" TextMode="Password"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                <td class="alinhar">
                    <asp:Label ID="Label10" runat="server" Text="Nova Senha"></asp:Label>

                </td>
                <td>
                    <asp:TextBox ID="TextBox2" CssClass="form-control" required title="" Width="180px" runat="server" TextMode="Password"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                <td class="alinhar">
                    <asp:Label ID="Label22" runat="server" Text="Confirmar Senha"></asp:Label>

                </td>
                <td>
                    <asp:TextBox ID="TextBox4" CssClass="form-control" required title="" Width="180px" runat="server" TextMode="Password"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
   ...
   <br />
       <br />
            <br />
                            <asp:Button ID="btnEditar" runat="server" CssClass="btn btn-default btn-primary" Text="Editar" />             
